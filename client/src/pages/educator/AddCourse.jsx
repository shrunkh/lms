  ...
  return (
    <div className='h-screen overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <form>
        ...
        <div className='flex items-center justify-between flex-wrap mt-4 mb-4 gap-6'>
        ...
        {/* Submit Button */}
        <button type='submit' className='bg-black text-white w-max py-2.5 px-8 rounded my-6'>
          Add Course
        </button>
      </form>
    </div>
